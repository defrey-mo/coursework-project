...
<nav class="main-nav">
    ...
    <h1>ABOUT US</h1>
                <section id="about-team" class=" bg-white card margin-block-end-20 margin-block-start-20">

            <h3 style="font-size: 1.6rem; font-weight:400" class="margin-block-end-20 text-main">Shop Now All Products Online</h3>
            <div class="about-us">
                <h3 class="about-us-all">
                    E-AGRIC shop : The Largest Online Shopping Site
                </h3>
                <p class="about">
 Online shopping sites are now part of our daily lives, because everyone has the possibility to buy everything without having to move out of the house. This is what E-AGRIC shop offers, What's even better, E-AGRIC shop offers you the possibility to find all the products you are looking for, In one store. This is what makes E-AGRIC shop one of the best online shopping sites in AFRICA.
                </p>
            </div>
              <div class="about-us">
                <h3 class="about-us-too">
                    Enjoy endless offers and discounts from E-AGRIC shop
                </h3>
